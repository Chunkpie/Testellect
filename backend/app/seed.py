    ...
    async with async_session_factory() as db:
        ...
        users_data = [
            ...
            User(
                ...
                email="v.singh@gseb.org",
                password_hash=hash_password("Deo@123"),
                role=UserRole.DEO,
                district_id=district.id,
            ),
        ]
        ...
        for i in range(1, 101):
            ...
            s_class_id = (
                ...
                if i <= 25
                    ...
                    all_class_ids[1]
                    if i <= 50
                    else all_class_ids[2] if i <= 75 else all_class_ids[3]
                )
            )
            s = Student(
        ...
        topic = Topic(
            chapter_id=chapter2.id, sequence=1, title_en="Types of Chemical Reactions"
        )
        db.add(topic)
        await db.flush()
        ...
        concepts_data = [
            ...
            Concept(
                topic_id=topic.id,
                name_en="Displacement Reaction",
                description="More reactive element displaces a less reactive one",
            ),
            Concept(
                topic_id=topic.id,
                name_en="Oxidation and Reduction",
                description="Loss and gain of electrons in chemical reactions",
            ),
        ]
        ...
        competencies = [
            Competency(
                name_en="Scientific Inquiry",
                nas_parakh_code="SCI.INQ.1",
                description="Ability to conduct scientific investigations",
            ),
            Competency(
                name_en="Data Analysis",
                nas_parakh_code="SCI.DA.1",
                description="Ability to analyze experimental data",
            ),
            Competency(
                name_en="Conceptual Understanding",
                nas_parakh_code="SCI.CU.1",
                description="Understanding of core scientific concepts",
            ),
            Competency(
                name_en="Numerical Problem Solving",
                nas_parakh_code="MATH.NPS.1",
                description="Solve numerical problems using mathematical concepts",
            ),
        ]
        ...
        question_templates = [
            {
                "text": "What is the product of a combination reaction between magnesium and oxygen?",
                "options": {"A": "MgO", "B": "MgO2", "C": "Mg2O", "D": "Mg2O3"},
                "correct": "A",
                "difficulty": Difficulty.EASY,
                "concept": concepts_data[0],
            },
            {
                ...
                "correct": "B",
                "difficulty": Difficulty.EASY,
                "concept": concepts_data[1],
            },
            {
                "text": "In the reaction Fe + CuSO4 -> FeSO4 + Cu, which element is displaced?",
                "options": {
                    "A": "Iron displaces Copper",
                    "B": "Copper displaces Iron",
                    "C": "Sulfur displaces Oxygen",
                    "D": "No displacement occurs",
                },
                "correct": "A",
                "difficulty": Difficulty.MEDIUM,
                "concept": concepts_data[2],
            },
            {
                ...
                "correct": "B",
                "difficulty": Difficulty.MEDIUM,
                "concept": concepts_data[3],
            },
            {
                "text": "A chemical reaction releases 250 kJ of energy. This is an example of:",
                "options": {
            ...
            {
                "text": "What happens to the rate of reaction when temperature is increased?",
                "options": {
                    "A": "Decreases",
                    "B": "Increases",
                    "C": "Remains same",
            ...
            {
                "text": "Which of the following statements about catalysts is correct?",
                "options": {
                    "A": "Catalysts are consumed in the reaction",
                    "B": "Catalysts increase activation energy",
                    "C": "Catalysts provide an alternative pathway with lower activation energy",
            ...
            {
                "text": "Balance the equation: Fe + H2O -> Fe3O4 + H2. What is the coefficient of H2?",
            ...
            {
                "text": "Which type of reaction is represented by: AgNO3 + NaCl -> AgCl + NaNO3?",
                "options": {
                    "A": "Combination",
                    "B": "Decomposition",
            ...
            },
            {
                ...
                "options": {
                    ...
                    "D": "Mass is converted to energy in all reactions",
                },
                "correct": "C",
                "difficulty": Difficulty.EASY,
                "concept": concepts_data[0],
            ...
            {
                "text": "If a polynomial p(x) = x^2 - 5x + 6, what are its zeroes?",
            ...
            {
                "text": "What is the degree of the polynomial 3x^4 + 2x^2 - x + 7?",
            ...
            {
                "text": "If alpha and beta are zeroes of x^2 - 3x + 2, what is alpha + beta?",
            ...
            {
                "text": "What is the remainder when x^3 - 3x^2 + 2x - 1 is divided by (x - 1)?",
            ...
            {
                "text": "Which of the following is a quadratic polynomial?",
                "options": {
                    "A": "x + 1",
                    "B": "x^2 + 2x + 1",
                    "C": "x^3 + 1",
            ...
            {
                "text": "The graph of a linear polynomial is a:",
                "options": {
                    "A": "Straight line",
                    "B": "Parabola",
                    "C": "Circle",
            ...
            {
                "text": "If p(x) = 2x^2 - 4x + 2, what is p(2)?",
            ...
            {
                "text": "What is the sum of zeroes of the polynomial x^2 - 5x + 6?",
            ...
            {
                "text": "How many zeroes can a quadratic polynomial have at most?",
        ...
        class_obj = Class(
            school_id=school_id, grade=10, section=None, academic_year="2026-27"
        )
        db.add(class_obj)
        await db.flush()
                    ...
                    "competencies": [
                        {
                            ...
                            "code": "SCI.INQ.1",
                            "description": "Scientific investigation skills",
                        }
                    ],
                    "misconceptions": [
                        "All reactions are reversible",
                        "Catalysts change product yield",
                    ],
                }
            ),
        )
