...
| **AI / ML** | Ollama (Local LLM), ChromaDB (Vector DB), PyMuPDF |
...
You must have [Ollama](https://ollama.com/) installed locally on your machine.
```bash
ollama run qwen3:8b
```
...
*   **Data Sovereignty:** Student names, marks, and school data never touch the public internet. All AI processing happens completely on-device.
